 ...
 */
int __wt_malloc(WT_SESSION_IMPL* session, size_t bytes_to_allocate, void* retp) {
    void* p;
 ...
 */
static int __realloc_func(WT_SESSION_IMPL* session,
 ...
 */
int __wt_realloc_noclear(WT_SESSION_IMPL* session,
                         size_t* bytes_allocated_ret,
                         size_t bytes_to_allocate,
                         void* retp) {
 ...
 */
int __wt_realloc_aligned(WT_SESSION_IMPL* session,
                         size_t* bytes_allocated_ret,
                         size_t bytes_to_allocate,
                         void* retp) {
 ...
 */
int __wt_memdup(WT_SESSION_IMPL* session, const void* str, size_t len, void* retp) {
    void* p;
