 ...
 */
int __wt_schema_get_table_uri(WT_SESSION_IMPL* session,
                              const char* uri,
                              bool ok_incomplete,
                              uint32_t flags,
                              WT_TABLE** tablep) {
 ...
 *	Get the table handle for the named table.
 */
int __wt_schema_get_table(WT_SESSION_IMPL* session,
                          const char* name,
                          size_t namelen,
                          bool ok_incomplete,
                          uint32_t flags,
 ...
 */
int __wt_schema_release_table(WT_SESSION_IMPL* session, WT_TABLE** tablep) {
    WT_DECL_RET;
    WT_TABLE* table;
 ...
 */
void __wt_schema_destroy_colgroup(WT_SESSION_IMPL* session, WT_COLGROUP** colgroupp) {
 ...
 */
int __wt_schema_destroy_index(WT_SESSION_IMPL* session, WT_INDEX** idxp) {
    WT_DECL_RET;
    WT_INDEX* idx;
 ...
 */
int __wt_schema_close_table(WT_SESSION_IMPL* session, WT_TABLE* table) {
    WT_DECL_RET;
    u_int i;
