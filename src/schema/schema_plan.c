 ...
 */
static int __find_next_col(WT_SESSION_IMPL* session,
                           WT_TABLE* table,
                           WT_CONFIG_ITEM* colname,
                           u_int* cgnump,
                           u_int* colnump,
                           char* coltype) {
 ...
 */
int __wt_schema_colcheck(WT_SESSION_IMPL* session,
 ...
 */
int __wt_struct_plan(WT_SESSION_IMPL* session,
                     WT_TABLE* table,
                     const char* columns,
                     size_t len,
                     bool value_only,
 ...
 */
static int __find_column_format(WT_SESSION_IMPL* session,
                                WT_TABLE* table,
                                WT_CONFIG_ITEM* colname,
                                bool value_only,
                                WT_PACK_VALUE* pv) {
 ...
 */
int __wt_struct_reformat(WT_SESSION_IMPL* session,
                         WT_TABLE* table,
                         const char* columns,
                         size_t len,
 ...
 */
int __wt_struct_truncate(WT_SESSION_IMPL* session,
