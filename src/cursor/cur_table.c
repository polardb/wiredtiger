 ...
 */
static int __curextract_insert(WT_CURSOR* cursor) {
 ...
 */
int __wt_apply_single_idx(WT_SESSION_IMPL* session,
                          WT_INDEX* idx,
                          WT_CURSOR* cur,
                          WT_CURSOR_TABLE* ctable,
                          int (*f)(WT_CURSOR*)) {
 ...
 */
static int __apply_idx(WT_CURSOR_TABLE* ctable, size_t func_off, bool skip_immutable) {
    WT_CURSOR** cp;
    WT_INDEX* idx;
    WT_SESSION_IMPL* session;
    u_int i;
 ...
 */
int __wt_curtable_get_key(WT_CURSOR* cursor, ...) {
    WT_CURSOR* primary;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    va_list ap;
 ...
 */
int __wt_curtable_get_value(WT_CURSOR* cursor, ...) {
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
    va_list ap;
 ...
 */
void __wt_curtable_set_key(WT_CURSOR* cursor, ...) {
 ...
 */
void __wt_curtable_set_value(WT_CURSOR* cursor, ...) {
    WT_CURSOR** cp;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_ITEM *item, *tmp;
 ...
 */
static int __curtable_compare(WT_CURSOR* a, WT_CURSOR* b, int* cmpp) {
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 *	next_random.
 */
static int __curtable_next_random(WT_CURSOR* cursor) {
 ...
 */
static int __curtable_prev(WT_CURSOR* cursor) {
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_reset(WT_CURSOR* cursor) {
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_search(WT_CURSOR* cursor) {
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_search_near(WT_CURSOR* cursor, int* exact) {
    WT_CURSOR *primary, **cp;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_insert(WT_CURSOR* cursor) {
    WT_CURSOR *primary, **cp;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_remove(WT_CURSOR* cursor) {
    WT_CURSOR* primary;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_reserve(WT_CURSOR* cursor) {
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
int __wt_table_range_truncate(WT_CURSOR_TABLE* start, WT_CURSOR_TABLE* stop) {
 ...
 */
static int __curtable_close(WT_CURSOR* cursor) {
    WT_CURSOR** cp;
    WT_CURSOR_TABLE* ctable;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curtable_complete(WT_SESSION_IMPL* session, WT_TABLE* table) {
    bool complete;
 ...
 */
static int __curtable_open_colgroups(WT_CURSOR_TABLE* ctable, const char* cfg_arg[]) {
    WT_CURSOR** cp;
    WT_SESSION_IMPL* session;
    WT_TABLE* table;
    /*
 ...
 */
int __wt_curtable_open(WT_SESSION_IMPL* session,
                       const char* uri,
                       WT_CURSOR* owner,
                       const char* cfg[],
                       WT_CURSOR** cursorp) {
