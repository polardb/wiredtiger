 ...
 */
static int __bulk_col_keycmp_err(WT_CURSOR_BULK* cbulk) {
    WT_CURSOR* cursor;
 ...
 */
static int __curbulk_insert_fix(WT_CURSOR* cursor) {
    WT_BTREE* btree;
 ...
 */
static int __curbulk_insert_fix_bitmap(WT_CURSOR* cursor) {
    WT_BTREE* btree;
    WT_CURSOR_BULK* cbulk;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curbulk_insert_var(WT_CURSOR* cursor) {
    WT_BTREE* btree;
    WT_CURSOR_BULK* cbulk;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __bulk_row_keycmp_err(WT_CURSOR_BULK* cbulk) {
    WT_CURSOR* cursor;
    WT_DECL_ITEM(a);
    WT_DECL_ITEM(b);
    WT_DECL_RET;
 ...
 */
static int __curbulk_insert_row(WT_CURSOR* cursor) {
    WT_BTREE* btree;
    WT_CURSOR_BULK* cbulk;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curbulk_insert_row_skip_check(WT_CURSOR* cursor) {
    WT_BTREE* btree;
    WT_CURSOR_BULK* cbulk;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
int __wt_curbulk_init(WT_SESSION_IMPL* session,
                      WT_CURSOR_BULK* cbulk,
                      bool bitmap,
                      bool skip_sort_check) {
    WT_CURSOR* c;
    WT_CURSOR_BTREE* cbt;
