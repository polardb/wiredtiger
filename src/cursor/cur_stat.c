 ...
 */
static int __curstat_print_value(WT_SESSION_IMPL* session, uint64_t v, WT_ITEM* buf) {
    if (v >= WT_BILLION)
 ...
 */
static int __curstat_get_key(WT_CURSOR* cursor, ...) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_ITEM* item;
 ...
 */
static int __curstat_get_value(WT_CURSOR* cursor, ...) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_ITEM* item;
    WT_SESSION_IMPL* session;
 ...
 */
static void __curstat_set_key(WT_CURSOR* cursor, ...) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_ITEM* item;
    WT_SESSION_IMPL* session;
 ...
 */
static void __curstat_set_value(WT_CURSOR* cursor, ...) {
    WT_UNUSED(cursor);
}
 ...
 */
static int __curstat_reset(WT_CURSOR* cursor) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curstat_search(WT_CURSOR* cursor) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
 ...
 */
static int __curstat_close(WT_CURSOR* cursor) {
    WT_CURSOR_STAT* cst;
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
    size_t i;
 ...
 */
static void __curstat_conn_init(WT_SESSION_IMPL* session, WT_CURSOR_STAT* cst) {
 ...
 */
void __wt_curstat_dsrc_final(WT_CURSOR_STAT* cst) {
 ...
 *	statistics.
 */
static int __curstat_join_next_set(WT_SESSION_IMPL* session,
                                   WT_CURSOR_STAT* cst,
                                   bool forw,
                                   bool init) {
 ...
 */
static int __curstat_join_desc(WT_CURSOR_STAT* cst, int slot, const char** resultp) {
 ...
 */
static int __curstat_join_init(WT_SESSION_IMPL* session,
                               WT_CURSOR* curjoin,
                               const char* cfg[],
                               WT_CURSOR_STAT* cst) {
    WT_CURSOR_JOIN* cjoin;
 ...
 */
static void __curstat_session_init(WT_SESSION_IMPL* session, WT_CURSOR_STAT* cst) {
    /*
 ...
 */
int __wt_curstat_init(WT_SESSION_IMPL* session,
                      const char* uri,
                      WT_CURSOR* curjoin,
                      const char* cfg[],
                      WT_CURSOR_STAT* cst) {
