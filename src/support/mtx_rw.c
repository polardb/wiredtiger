 ...
 */
int __wt_rwlock_init(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    l->u.v = 0;
 ...
 */
void __wt_rwlock_destroy(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    l->u.v = 0;
 ...
 */
int __wt_try_readlock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
    int64_t** stats;
 ...
 */
static bool __read_blocked(WT_SESSION_IMPL* session) {
 ...
 *	Get a shared lock.
 */
void __wt_readlock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
 ...
 */
void __wt_readunlock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
 ...
 */
int __wt_try_writelock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
    int64_t** stats;
 ...
 */
static bool __write_blocked(WT_SESSION_IMPL* session) {
    WT_RWLOCK* l;
 ...
 */
void __wt_writelock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
    uint64_t time_diff, time_start, time_stop;
    int64_t *session_stats, **stats;
    uint8_t ticket;
 ...
 */
void __wt_writeunlock(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK new, old;
 ...
 */
bool __wt_rwlock_islocked(WT_SESSION_IMPL* session, WT_RWLOCK* l) {
    WT_RWLOCK old;
