 ...
 */
int __wt_buf_fmt(WT_SESSION_IMPL* session, WT_ITEM* buf, const char* fmt, ...)
 ...
 */
int __wt_buf_catfmt(WT_SESSION_IMPL* session, WT_ITEM* buf, const char* fmt, ...)
    WT_GCC_FUNC_ATTRIBUTE((format(printf, 3, 4))) WT_GCC_FUNC_ATTRIBUTE((visibility("default"))) {
    /*
 ...
 * string.
 */
const char* __wt_buf_set_printable(WT_SESSION_IMPL* session,
                                   const void* p,
                                   size_t size,
                                   WT_ITEM* buf) {
 ...
 */
const char* __wt_buf_set_printable_format(
 ...
 * byte size.
 */
const char* __wt_buf_set_size(WT_SESSION_IMPL* session, uint64_t size, bool exact, WT_ITEM* buf) {
    WT_DECL_RET;
 ...
 */
int __wt_scr_alloc_func(WT_SESSION_IMPL* session,
                        size_t size,
                        WT_ITEM** scratchp
