...
int wiredtiger_struct_pack(
    WT_SESSION* wt_session, void* buffer, size_t len, const char* format, ...) {
    WT_DECL_RET;
 ...
 */
int wiredtiger_struct_size(WT_SESSION* wt_session, size_t* lenp, const char* format, ...) {
    WT_DECL_RET;
    WT_SESSION_IMPL* session;
    va_list ap;
 ...
 *	Pack a byte string (extension API).
 */
int __wt_ext_struct_pack(WT_EXTENSION_API* wt_api,
 ...
 *	Unpack a byte string (extension API).
 */
int __wt_ext_struct_unpack(WT_EXTENSION_API* wt_api,
                           WT_SESSION* wt_session,
                           const void* buffer,
                           size_t len,
                           const char* fmt,
