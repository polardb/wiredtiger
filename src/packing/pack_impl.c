 ...
 */
int __wt_struct_size(WT_SESSION_IMPL* session, size_t* lenp, const char* fmt, ...) {
    WT_DECL_RET;
    va_list ap;
 ...
 *	Pack a byte string.
 */
int __wt_struct_pack(WT_SESSION_IMPL* session, void* buffer, size_t len, const char* fmt, ...) {
    WT_DECL_RET;
    va_list ap;
 ...
 */
int __wt_struct_unpack(
    WT_SESSION_IMPL* session, const void* buffer, size_t len, const char* fmt, ...) {
    WT_DECL_RET;
    va_list ap;
 ...
 */
int __wt_struct_repack(WT_SESSION_IMPL* session,
                       const char* infmt,
                       const char* outfmt,
                       const WT_ITEM* inbuf,
                       WT_ITEM* outbuf) {
