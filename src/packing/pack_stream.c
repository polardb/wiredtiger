 ...
 */
int wiredtiger_unpack_start(WT_SESSION* wt_session,
                            const char* format,
                            const void* buffer,
                            size_t size,
                            WT_PACK_STREAM** psp) {
 ...
 */
int __wt_ext_pack_start(WT_EXTENSION_API* wt_api,
 ...
 */
int __wt_ext_unpack_start(WT_EXTENSION_API* wt_api,
                          WT_SESSION* wt_session,
                          const char* format,
                          const void* buffer,
                          size_t size,
 ...
 */
int __wt_ext_pack_close(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, size_t* usedp) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_pack_item(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, WT_ITEM* item) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_pack_int(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, int64_t i) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_pack_str(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, const char* s) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_pack_uint(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, uint64_t u) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_unpack_item(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, WT_ITEM* item) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_unpack_int(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, int64_t* ip) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_unpack_str(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, const char** sp) {
    WT_UNUSED(wt_api);
 ...
 */
int __wt_ext_unpack_uint(WT_EXTENSION_API* wt_api, WT_PACK_STREAM* ps, uint64_t* up) {
    WT_UNUSED(wt_api);
