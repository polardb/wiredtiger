 ...
 */
int __wt_to_utf16_string(WT_SESSION_IMPL* session, const char* utf8, WT_ITEM** outbuf) {
    DWORD windows_error;
    int bufferSize;
 ...
 */
int __wt_to_utf8_string(WT_SESSION_IMPL* session, const wchar_t* wide, WT_ITEM** outbuf) {
    DWORD windows_error;
    int bufferSize;
