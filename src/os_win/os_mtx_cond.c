 ...
 */
int __wt_cond_alloc(WT_SESSION_IMPL* session, const char* name, WT_CONDVAR** condp) {
    WT_CONDVAR* cond;
 ...
 */
void __wt_cond_wait_signal(WT_SESSION_IMPL* session,
                           WT_CONDVAR* cond,
                           uint64_t usecs,
 ...
 */
void __wt_cond_signal(WT_SESSION_IMPL* session, WT_CONDVAR* cond) {
    WT_DECL_RET;
 ...
 */
void __wt_cond_destroy(WT_SESSION_IMPL* session, WT_CONDVAR** condp) {
    WT_CONDVAR* cond;
