 ...
 */
static inline size_t __wt_vsize_posint(uint64_t x) {
    int lz;
 ...
 */
static inline size_t __wt_vsize_negint(uint64_t x) {
    int lz;
 ...
 */
static inline size_t __wt_vsize_uint(uint64_t x) {
    if (x <= POS_1BYTE_MAX)
        return (1);
 ...
 */
static inline size_t __wt_vsize_int(int64_t x) {
    if (x < NEG_2BYTE_MIN)
