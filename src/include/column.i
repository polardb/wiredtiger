 ...
 */
static inline WT_INSERT* __col_insert_search_gt(WT_INSERT_HEAD* ins_head, uint64_t recno) {
    WT_INSERT *ins, **insp;
    int i;
 ...
 */
static inline WT_INSERT* __col_insert_search_lt(WT_INSERT_HEAD* ins_head, uint64_t recno) {
    WT_INSERT *ins, **insp;
    int i;
 ...
 */
static inline WT_INSERT* __col_insert_search_match(WT_INSERT_HEAD* ins_head, uint64_t recno) {
 ...
 */
static inline WT_INSERT* __col_insert_search(WT_INSERT_HEAD* ins_head,
                                             WT_INSERT*** ins_stack,
 ...
 */
static inline uint64_t __col_var_last_recno(WT_REF* ref) {
    WT_COL_RLE* repeat;
    WT_PAGE* page;
 ...
 */
static inline uint64_t __col_fix_last_recno(WT_REF* ref) {
    WT_PAGE* page;
 ...
 */
static inline WT_COL* __col_var_search(WT_REF* ref, uint64_t recno, uint64_t* start_recnop) {
    WT_COL_RLE* repeat;
    WT_PAGE* page;
