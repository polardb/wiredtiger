 ...
 */
static inline void __cursor_novalue(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_checkkey(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_checkvalue(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_localkey(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_localvalue(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_needkey(WT_CURSOR* cursor) {
 ...
 * the tree, there's an obvious race with the cursor moving and the reference.
 */
static inline int __cursor_needvalue(WT_CURSOR* cursor) {
 ...
 */
static inline int __cursor_kv_return(WT_SESSION_IMPL* session,
                                     WT_CURSOR_BTREE* cbt,
                                     WT_UPDATE* upd) {
 ...
 *	Cursor call setup.
 */
static inline int __cursor_func_init(WT_CURSOR_BTREE* cbt, bool reenter) {
    WT_SESSION_IMPL* session;
 ...
 */
static inline int __cursor_row_slot_return(WT_CURSOR_BTREE* cbt, WT_ROW* rip, WT_UPDATE* upd) {
    WT_BTREE* btree;
    WT_CELL* cell;
