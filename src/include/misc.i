 ...
 */
static inline void __wt_cond_wait(WT_SESSION_IMPL* session,
                                  WT_CONDVAR* cond,
                                  uint64_t usecs,
 ...
 */
static inline u_char __wt_hex(int c) {
 ...
 */
static inline uint64_t __wt_rdtsc(void) {
#if defined(__i386)
    {
        uint64_t x;
 ...
 */
static inline int __wt_snprintf_len_set(char* buf,
                                        size_t size,
                                        size_t* retsizep,
                                        const char* fmt,
 ...
 */
static inline int __wt_vsnprintf_len_set(
 ...
 */
static inline int __wt_snprintf_len_incr(char* buf,
                                         size_t size,
                                         size_t* retsizep,
                                         const char* fmt,
                                         ...) WT_GCC_FUNC_ATTRIBUTE((format(printf, 4, 5))) {
