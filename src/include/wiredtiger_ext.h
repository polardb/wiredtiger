...
/* !!! To maintain backwards compatibility, this structure is append-only. */
     ...
     */
    int (*collator_config)(WT_EXTENSION_API* wt_api,
                           WT_SESSION* session,
                           const char* uri,
     ...
     */
    int (*collate)(WT_EXTENSION_API* wt_api,
                   WT_SESSION* session,
     ...
     */
    int (*config_get)(WT_EXTENSION_API* wt_api,
                      WT_SESSION* session,
                      WT_CONFIG_ARG* config,
                      const char* key,
     ...
     * @snippet ex_data_source.c WT_EXTENSION config_get
     */
    int (*config_get_string)(WT_EXTENSION_API* wt_api,
                             WT_SESSION* session,
                             const char* config,
                             const char* key,
                             WT_CONFIG_ITEM* value);
     ...
     */
    int (*config_parser_open)(WT_EXTENSION_API* wt_api,
                              WT_SESSION* session,
                              const char* config,
                              size_t len,
     ...
     * @errors
     */
    int (*struct_pack)(WT_EXTENSION_API* wt_api,
                       WT_SESSION* session,
                       void* buffer,
                       size_t size,
                       const char* format,
     ...
     * @errors
     */
    int (*struct_unpack)(WT_EXTENSION_API* wt_api,
                         WT_SESSION* session,
                         const void* buffer,
                         size_t size,
                         const char* format,
