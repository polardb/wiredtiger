 ...
 */
static void __nsnap_destroy(WT_SESSION_IMPL* session, WT_NAMED_SNAPSHOT* nsnap) {
 ...
 *	write locked.
 */
static int __nsnap_drop_one(WT_SESSION_IMPL* session, WT_CONFIG_ITEM* name) {
 ...
 */
static int __nsnap_drop_to(WT_SESSION_IMPL* session, WT_CONFIG_ITEM* name, bool inclusive) {
 ...
 */
int __wt_txn_named_snapshot_begin(WT_SESSION_IMPL* session, const char* cfg[]) {
    WT_CONFIG_ITEM cval;
    WT_DECL_RET;
 ...
 */
int __wt_txn_named_snapshot_drop(WT_SESSION_IMPL* session, const char* cfg[]) {
 ...
 */
int __wt_txn_named_snapshot_get(WT_SESSION_IMPL* session, WT_CONFIG_ITEM* nameval) {
 ...
 */
int __wt_txn_named_snapshot_config(WT_SESSION_IMPL* session,
                                   const char* cfg[],
                                   bool* has_create,
                                   bool* has_drops) {
 ...
 */
void __wt_txn_named_snapshot_destroy(WT_SESSION_IMPL* session) {
    WT_NAMED_SNAPSHOT* nsnap;
    WT_TXN_GLOBAL* txn_global;
