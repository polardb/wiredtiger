 ...
 */
static inline void __evict_exclusive_clear(WT_SESSION_IMPL* session,
                                           WT_REF* ref,
 ...
 */
int __wt_page_release_evict(WT_SESSION_IMPL* session, WT_REF* ref) {
    WT_BTREE* btree;
    WT_DECL_RET;
    WT_PAGE* page;
 ...
 *	Evict a page.
 */
int __wt_evict(WT_SESSION_IMPL* session, WT_REF* ref, bool closing, uint32_t previous_state) {
 ...
 *	split.
 */
static int __evict_delete_ref(WT_SESSION_IMPL* session, WT_REF* ref, bool closing) {
    WT_DECL_RET;
    WT_PAGE* parent;
 ...
 */
static int __evict_page_clean_update(WT_SESSION_IMPL* session, WT_REF* ref, bool closing) {
    WT_DECL_RET;
 ...
 */
static int __evict_page_dirty_update(WT_SESSION_IMPL* session, WT_REF* ref, bool closing) {
    WT_ADDR* addr;
    WT_DECL_RET;
    WT_MULTI multi;
    WT_PAGE_MODIFY* mod;
 ...
 */
static int __evict_review(WT_SESSION_IMPL* session, WT_REF* ref, bool closing, bool* inmem_splitp) {
    WT_CACHE* cache;
    WT_CONNECTION_IMPL* conn;
    WT_DECL_RET;
    WT_PAGE* page;
