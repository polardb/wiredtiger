 ...
 */
static void __evict_stat_walk(WT_SESSION_IMPL* session) {
    WT_BTREE* btree;
    WT_CACHE* cache;
    WT_PAGE* page;
    WT_REF* next_walk;
    ...
    while (__wt_tree_walk_count(session,
                                &next_walk,
                                &walk_count,
 ...
 */
void __wt_curstat_cache_walk(WT_SESSION_IMPL* session) {
    WT_BTREE* btree;
