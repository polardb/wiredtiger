 ...
 */
static int __posix_std_fallocate(WT_FILE_HANDLE* file_handle,
 ...
 */
static int __posix_sys_fallocate(WT_FILE_HANDLE* file_handle,
                                 WT_SESSION* wt_session,
                                 wt_off_t offset) {
 ...
 */
static int __posix_posix_fallocate(WT_FILE_HANDLE* file_handle,
                                   WT_SESSION* wt_session,
                                   wt_off_t offset) {
 ...
 *	Extend the file.
 */
int __wt_posix_file_extend(WT_FILE_HANDLE* file_handle, WT_SESSION* wt_session, wt_off_t offset) {
    /*
