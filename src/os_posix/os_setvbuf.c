 ...
 */
void __wt_stream_set_line_buffer(FILE* fp) WT_GCC_FUNC_ATTRIBUTE((visibility("default"))) {
    /*
 ...
 */
void __wt_stream_set_no_buffer(FILE* fp) WT_GCC_FUNC_ATTRIBUTE((visibility("default"))) {
