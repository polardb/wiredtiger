 ...
 */
static inline int __key_return(WT_SESSION_IMPL* session, WT_CURSOR_BTREE* cbt) {
    WT_CURSOR* cursor;
    WT_ITEM* tmp;
    WT_PAGE* page;
    WT_ROW* rip;
 ...
 */
static inline int __value_return(WT_SESSION_IMPL* session, WT_CURSOR_BTREE* cbt) {
    WT_BTREE* btree;
    WT_CELL* cell;
 ...
 *	value.
 */
int __wt_value_return_upd(WT_SESSION_IMPL* session,
                          WT_CURSOR_BTREE* cbt,
                          WT_UPDATE* upd,
 ...
 *	Change the cursor to reference an internal return key.
 */
int __wt_key_return(WT_SESSION_IMPL* session, WT_CURSOR_BTREE* cbt) {
    WT_CURSOR* cursor;
 ...
 */
int __wt_value_return(WT_SESSION_IMPL* session, WT_CURSOR_BTREE* cbt, WT_UPDATE* upd) {
    WT_CURSOR* cursor;
