 ...
 * pages it references).
 */
void __wt_free_ref(WT_SESSION_IMPL* session, WT_REF* ref, int page_type, bool free_pages) {
    WT_IKEY* ikey;
 ...
 */
void __wt_free_ref_index(WT_SESSION_IMPL* session,
                         WT_PAGE* page,
 ...
 */
static void __free_skip_array(WT_SESSION_IMPL* session,
                              WT_INSERT_HEAD** head_arg,
                              uint32_t entries,
                              bool update_ignore) {
    WT_INSERT_HEAD** head;
 ...
 */
static void __free_skip_list(WT_SESSION_IMPL* session, WT_INSERT* ins, bool update_ignore) {
    WT_INSERT* next;
 ...
 */
static void __free_update(WT_SESSION_IMPL* session,
                          WT_UPDATE** update_head,
                          uint32_t entries,
                          bool update_ignore) {
    WT_UPDATE** updp;
 ...
 */
void __wt_free_update_list(WT_SESSION_IMPL* session, WT_UPDATE* upd) {
    WT_UPDATE* next;
