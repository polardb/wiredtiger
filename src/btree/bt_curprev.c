 ...
 */
static inline int __cursor_fix_append_prev(WT_CURSOR_BTREE* cbt, bool newpage, bool restart) {
    WT_SESSION_IMPL* session;
    WT_UPDATE* upd;
 ...
 */
static inline int __cursor_fix_prev(WT_CURSOR_BTREE* cbt, bool newpage, bool restart) {
    WT_BTREE* btree;
    WT_PAGE* page;
    WT_SESSION_IMPL* session;
    WT_UPDATE* upd;
 ...
 */
static inline int __cursor_var_append_prev(WT_CURSOR_BTREE* cbt, bool newpage, bool restart) {
    WT_SESSION_IMPL* session;
    WT_UPDATE* upd;
 ...
 */
static inline int __cursor_var_prev(WT_CURSOR_BTREE* cbt, bool newpage, bool restart) {
    WT_CELL* cell;
 ...
 */
static inline int __cursor_row_prev(WT_CURSOR_BTREE* cbt, bool newpage, bool restart) {
    WT_INSERT* ins;
    WT_ITEM* key;
    WT_PAGE* page;
    WT_ROW* rip;
 ...
 */
int __wt_btcur_prev(WT_CURSOR_BTREE* cbt, bool truncating) {
    WT_CURSOR* cursor;
    WT_DECL_RET;
    WT_PAGE* page;
    WT_SESSION_IMPL* session;
