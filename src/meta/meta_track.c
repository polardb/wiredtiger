 ...
 *	Clear the structure.
 */
static void __meta_track_clear(WT_SESSION_IMPL* session, WT_META_TRACK* trk) {
 ...
 */
static void __meta_track_err(WT_SESSION_IMPL* session) {
    WT_META_TRACK* trk;
 ...
 */
static int __meta_track_apply(WT_SESSION_IMPL* session, WT_META_TRACK* trk) {
    WT_BM* bm;
    WT_BTREE* btree;
    WT_DECL_RET;
 ...
 */
static int __meta_track_unroll(WT_SESSION_IMPL* session, WT_META_TRACK* trk) {
    WT_BM* bm;
    WT_BTREE* btree;
    WT_DECL_RET;
 ...
 */
int __wt_meta_track_off(WT_SESSION_IMPL* session, bool need_sync, bool unroll) {
    WT_DECL_RET;
 ...
 *	main transaction.
 */
void __wt_meta_track_sub_on(WT_SESSION_IMPL* session) {
 ...
 */
int __wt_meta_track_drop(WT_SESSION_IMPL* session, const char* filename) {
    WT_DECL_RET;
    WT_META_TRACK* trk;
 ...
 */
int __wt_meta_track_handle_lock(WT_SESSION_IMPL* session, bool created) {
    WT_META_TRACK* trk;
 ...
 */
int __wt_meta_track_init(WT_SESSION_IMPL* session) {
 ...
 */
int __wt_meta_track_destroy(WT_SESSION_IMPL* session) {
    WT_CONNECTION_IMPL* conn;
    WT_DECL_RET;
