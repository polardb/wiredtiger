 ...
 */
int __wt_config_collapse(WT_SESSION_IMPL* session, const char** cfg, char** config_ret) {
    WT_CONFIG cparser;
    WT_CONFIG_ITEM k, v;
    WT_DECL_ITEM(tmp);
    WT_DECL_RET;
 ...
 */
static int __config_merge_scan(
 ...
 */
static void __strip_comma(WT_ITEM* buf) {
 ...
 */
static int __config_merge_format_next(WT_SESSION_IMPL* session,
                                      const char* prefix,
                                      size_t plen,
                                      size_t* enp,
                                      WT_CONFIG_MERGE* cp,
 ...
 */
static int __config_merge_format(WT_SESSION_IMPL* session,
                                 WT_CONFIG_MERGE* cp,
 ...
 */
static int WT_CDECL __config_merge_cmp(const void* a, const void* b) {
 ...
 */
int __wt_config_merge(WT_SESSION_IMPL* session,
                      const char** cfg,
