...
static const WT_CONFIG_ENTRY config_entries[] = {
    {"WT_CONNECTION.add_collator", "", NULL, 0},
    {"WT_CONNECTION.add_compressor", "", NULL, 0},
    {"WT_CONNECTION.add_data_source", "", NULL, 0},
    {"WT_CONNECTION.add_encryptor", "", NULL, 0},
    {"WT_CONNECTION.add_extractor", "", NULL, 0},
    ...
    {"WT_CONNECTION.debug_info",
     ...
     ",txn=false",
     confchk_WT_CONNECTION_debug_info,
     6},
    {"WT_CONNECTION.load_extension",
     ...
     confchk_WT_CONNECTION_load_extension,
     4},
    {"WT_CONNECTION.open_session",
     "cache_cursors=true,ignore_cache_size=false,"
     "isolation=read-committed",
     confchk_WT_CONNECTION_open_session,
     3},
    {"WT_CONNECTION.query_timestamp",
     "get=all_committed",
     confchk_WT_CONNECTION_query_timestamp,
     1},
    {"WT_CONNECTION.reconfigure",
     ...
     confchk_WT_CONNECTION_reconfigure,
     24},
    ...
    {"WT_CONNECTION.set_timestamp",
     ...
     "stable_timestamp=",
     confchk_WT_CONNECTION_set_timestamp,
     4},
    ...
    {"WT_SESSION.open_cursor",
     ...
     "statistics=,target=",
     confchk_WT_SESSION_open_cursor,
     14},
    {"WT_SESSION.prepare_transaction",
     "prepare_timestamp=",
     confchk_WT_SESSION_prepare_transaction,
     1},
    ...
    {"WT_SESSION.reconfigure",
     "cache_cursors=true,ignore_cache_size=false,"
     "isolation=read-committed",
     confchk_WT_SESSION_reconfigure,
     3},
    {"WT_SESSION.rename", "", NULL, 0},
    {"WT_SESSION.reset", "", NULL, 0},
...
int __wt_conn_config_init(WT_SESSION_IMPL* session) {
...
void __wt_conn_config_discard(WT_SESSION_IMPL* session) {
    WT_CONNECTION_IMPL* conn;
 ...
 */
const WT_CONFIG_ENTRY* __wt_conn_config_match(const char* method) {
