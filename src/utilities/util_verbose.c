 ...
 */
static int __handle_error_verbose(WT_EVENT_HANDLER* handler,
                                  WT_SESSION* session,
                                  int error,
                                  const char* errmsg) {
    WT_UNUSED(handler);
 ...
 */
static int __handle_message_verbose(WT_EVENT_HANDLER* handler,
                                    WT_SESSION* session,
                                    const char* message) {
    WT_UNUSED(handler);
    WT_UNUSED(session);
 ...
 */
static int __handle_progress_verbose(WT_EVENT_HANDLER* handler,
                                     WT_SESSION* session,
