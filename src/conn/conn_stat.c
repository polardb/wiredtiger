 ...
 */
static int __stat_config_discard(WT_SESSION_IMPL* session) {
 ...
 */
static int __statlog_config(WT_SESSION_IMPL* session, const char** cfg, bool* runp) {
 ...
 */
static int __statlog_print_header(WT_SESSION_IMPL* session) {
    WT_CONNECTION_IMPL* conn;
 ...
 */
static int __statlog_print_table_name(WT_SESSION_IMPL* session, const char* name, bool conn_stats) {
    WT_CONNECTION_IMPL* conn;
 ...
 */
static int __statlog_print_footer(WT_SESSION_IMPL* session) {
    WT_CONNECTION_IMPL* conn;
 ...
 */
static int __statlog_dump(WT_SESSION_IMPL* session, const char* name, bool conn_stats) {
    WT_CONNECTION_IMPL* conn;
    WT_CURSOR* cursor;
    WT_DECL_ITEM(tmp);
    WT_DECL_RET;
 ...
 */
static int __statlog_log_one(WT_SESSION_IMPL* session, WT_ITEM* path, WT_ITEM* tmp) {
    struct timespec ts;
    struct tm localt;
    WT_CONNECTION_IMPL* conn;
 ...
 * running.
 */
static int __statlog_on_close(WT_SESSION_IMPL* session) {
    WT_CONNECTION_IMPL* conn;
    WT_DECL_ITEM(tmp);
    WT_DECL_RET;
 ...
 */
static bool __statlog_server_run_chk(WT_SESSION_IMPL* session) {
 ...
 */
int __wt_statlog_destroy(WT_SESSION_IMPL* session, bool is_close) {
    WT_CONNECTION_IMPL* conn;
    WT_DECL_RET;
