 ...
 */
static int __ckpt_server_config(WT_SESSION_IMPL* session, const char** cfg, bool* startp) {
    WT_CONFIG_ITEM cval;
 ...
 */
static bool __ckpt_server_run_chk(WT_SESSION_IMPL* session) {
 ...
 */
void __wt_checkpoint_signal(WT_SESSION_IMPL* session, wt_off_t logsize) {
    WT_CONNECTION_IMPL* conn;
