 ...
 */
static int __conn_compat_parse(WT_SESSION_IMPL* session,
                               WT_CONFIG_ITEM* cvalp,
                               uint16_t* majorp,
                               uint16_t* minorp) {
 ...
 */
int __wt_conn_compat_config(WT_SESSION_IMPL* session, const char** cfg, bool reconfig) {
    WT_CONFIG_ITEM cval;
 ...
 */
int __wt_conn_optrack_setup(WT_SESSION_IMPL* session, const char* cfg[], bool reconfig) {
    WT_CONFIG_ITEM cval;
    WT_CONNECTION_IMPL* conn;
    WT_DECL_ITEM(buf);
    WT_DECL_RET;
 ...
 */
int __wt_conn_optrack_teardown(WT_SESSION_IMPL* session, bool reconfig) {
    WT_CONNECTION_IMPL* conn;
    WT_DECL_RET;
 ...
 */
int __wt_conn_statistics_config(WT_SESSION_IMPL* session, const char* cfg[]) {
 ...
 */
int __wt_conn_reconfig(WT_SESSION_IMPL* session, const char** cfg) {
    WT_CONNECTION_IMPL* conn;
    WT_DECL_RET;
    const char* p;
