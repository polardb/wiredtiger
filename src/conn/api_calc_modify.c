 ...
 *	exceeded.
 */
static int __cm_add_modify(WT_CM_STATE* cms,
                           const uint8_t* p2,
                           const uint8_t* m1,
                           const uint8_t* m2,
                           WT_MODIFY* entries,
 ...
 */
static void __cm_extend(WT_CM_STATE* cms,
                        const uint8_t* m1,
                        const uint8_t* m2,
                        WT_CM_MATCH* match) {
    const uint8_t *p1, *p2;
 ...
 */
static inline uint64_t __cm_fingerprint(const uint8_t* p) {
    uint64_t h;
 ...
 */
int wiredtiger_calc_modify(WT_SESSION* wt_session,
                           const WT_ITEM* oldv,
                           const WT_ITEM* newv,
                           size_t maxdiff,
                           WT_MODIFY* entries,
